...
여기서 오차를 만드는 과정에 있어, 카메라의 좌표와 이미지의 좌표를 바꿀 필요가 있었습니다. 따라서 이를 위해서 아래의 이미지와 같이 __축방향의 값을 변환__하여 오차의 값으로 정상적으로 생성할 수 있도록 하는 함수를 사용하였습니다. 이때 출력된 값은 rad에서 deg 단위로 변환한 함수를 거친 값입니다.   
