...
이 코드는 gstreamer를 통해서 젯슨에 연결된 CSI 카메라로 획득한 이미지를 읽어옵니다. 읽어온 이미지는 imwrite를 통해서 ***output_l.mp4, output_r.mp4로 저장*** 합니다. 이는 [JetsonHacksNano](https://github.com/JetsonHacksNano/CSI-Camera)이 제작한 CSI 카메라 연결코드를 기반으로 하였습니다.
&nbsp;
